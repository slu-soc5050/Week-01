...
log using week-01-markdoc.txt, text replace

// ==========================================================================

/*
file name - week-01-markdoc.do
...
quietly log using week-01-markdoc.smcl, replace smcl name(markdoc)
...
markdoc week-01-markdoc, replace export(md) install
